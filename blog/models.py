...
class BlogClass (models.Model):
    class Meta ():
        db_table = 'blog_class' # теперь мы будем знать к чему относиться наша модель или ее название
    '''
    наша стандартная модель
    '''
    blog_title = models.CharField (max_length=200, verbose_name= 'Заголовок', blank=True,)
    blog_text = models.TextField (verbose_name='текст', blank=True, )
    #blog_text = RichTextField(verbose_name='текст', blank=True, )
    ...
    blog_date = models.DateTimeField (verbose_name='Дата',)
