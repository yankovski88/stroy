...
class NuClass (models.Model):
    class Meta ():
        db_table = 'nu_class' # теперь мы будем знать к чему относиться наша модель или ее название
    '''
    наша стандартная модель
    '''
    nu_title = models.CharField (max_length=200, verbose_name= 'Заголовок', blank=True,)
    nu_text = models.TextField (verbose_name='текст', blank=True, )
    ...
    nu_date = models.DateTimeField (verbose_name='Дата',)
